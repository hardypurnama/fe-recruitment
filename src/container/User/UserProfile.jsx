      ...
      axios
        ...
        .then((result) => {
          result.data.tgl_lahir=result.data.tgl_lahir?
            result.data.tgl_lahir.slice(0,10):null;
          setUser(result.data);
        });
    };
    useEffect(() => {
        ...
        <Col className="col-md-10">
          ...
          <div>
            ...
            <Form.Group className="mb-3" controlId="formBasicnhp">
              ...
              <Form.Control type="nhp" placeholder="no hp" name="nohp" value={user.nohp} />
            </Form.Group>

            <Form.Group className="mb-3" controlId="formBasictglLahir" >
              <Form.Label>tgl_lahir</Form.Label>
              <Form.Control type="text" placeholder="tanggal lahir" name="tgl_lahir" value={user.tgl_lahir} />
            </Form.Group>

            <Form.Group className="mb-3" controlId="formBasicdomisili">
              <Form.Label>domisili</Form.Label>
              <Form.Control type="text" placeholder="domisili" name="domisili" value={user.domisili} />
            </Form.Group>
